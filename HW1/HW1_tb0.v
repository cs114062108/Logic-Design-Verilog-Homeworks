...
module hw1_testbench_0;
    ...
    initial begin
        ...
        $display("Begin!");
        $display("Time\t Mode\t Input A (Signed/Binary)       Input B (Signed/Binary)       |  Output Sum (Signed/Binary)  C8  Overflow");
        $display("------------------------------------------------------------------------------------------------------------------------");
        ...
        // Expected: sum = 20, overflow = 0, c8 = 1
        // -----------------------------------------------------------------
        mode = 1'b1; A = 8'd50; B = 8'd30; #10;

        // -----------------------------------------------------------------
        // Testcase 6: Simple subtraction (30 - 50 = -20)
        // Expected: sum = -20, overflow = 0, c8 = 0
        // -----------------------------------------------------------------
        mode = 1'b1; A = 8'd30; B = 8'd50; #10;

        // -----------------------------------------------------------------
        // Testcase 7: Subtraction leading to overflow (100 - (-50) = 150)
        ...
        // -----------------------------------------------------------------
        // Testcase 8: Negative minus positive leading to overflow (-100 - 50 = -150)
        // -150 < -128
        // Expected: sum = 106, overflow = 1
        // -----------------------------------------------------------------
        mode = 1'b1; A = -8'd100; B = 8'd50; #10;
